defmodule GameDatabaseWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GameDatabaseWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GameDatabaseWeb.Gettext, "errors", msg, opts)
    end
  end
